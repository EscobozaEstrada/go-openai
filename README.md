# Go OpenAI
[![Go Reference](https://pkg.go.dev/badge/github.com/EscobozaEstrada/go-openai.svg)](https://pkg.go.dev/github.com/EscobozaEstrada/go-openai)
[![Go Report Card](https://goreportcard.com/badge/github.com/EscobozaEstrada/go-openai)](https://goreportcard.com/report/github.com/EscobozaEstrada/go-openai)
[![codecov](https://codecov.io/gh/EscobozaEstrada/go-openai/branch/master/graph/badge.svg?token=bCbIfHLIsW)](https://codecov.io/gh/EscobozaEstrada/go-openai)
...
```
go get github.com/EscobozaEstrada/go-openai
```
...
import (
	"context"
	"fmt"
	openai "github.com/EscobozaEstrada/go-openai"
)
...
See also: https://pkg.go.dev/github.com/EscobozaEstrada/go-openai#ClientConfig
</details>
...
import (
	...
	"github.com/EscobozaEstrada/go-openai"
)
...
**Related Issues:**  
[omitempty option of request struct will generate incorrect request when parameter is 0.](https://github.com/EscobozaEstrada/go-openai/issues/9)
...
**Related Issues:**  
[Is it possible to join the implementation of GPT3 Tokenizer](https://github.com/EscobozaEstrada/go-openai/issues/62)

## Contributing

By following [Contributing Guidelines](https://github.com/EscobozaEstrada/go-openai/blob/master/CONTRIBUTING.md), we hope to ensure that your contributions are made smoothly and efficiently.

## Thank you

We want to take a moment to express our deepest gratitude to the [contributors](https://github.com/EscobozaEstrada/go-openai/graphs/contributors) and sponsors of this project:
